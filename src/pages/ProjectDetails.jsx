  ...
  const timeline = [
    {
      ...
      date: '2024-02-15',
      status: 'Completed',
      description: 'Initial planning and resource allocation completed.',
    },
    {
      id: 2,
      ...
      date: '2024-03-01',
      status: 'Completed',
      description: 'Garden site cleared and soil prepared.',
    },
    {
      id: 3,
      ...
      date: '2024-03-15',
      status: 'In Progress',
      description: 'Initial planting of vegetables and herbs.',
    },
    {
      id: 4,
      ...
      date: '2024-04-01',
      status: 'Upcoming',
      description: 'Educational program for local youth begins.',
    },
    {
      id: 5,
      title: 'First Harvest',
      date: '2024-06-15',
      status: 'Upcoming',
      description: 'Expected first harvest of produce.',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-between items-start mb-8">
          <div>
            ...
            <p className="mt-2 text-gray-600">{project.organization}</p>
          </div>
        ...
        <div className="border-b border-gray-200 mb-8">
          <nav className="-mb-px flex space-x-8">
            {['overview', 'team', 'timeline', 'updates'].map((tab) => (
              <button
                key={tab}
